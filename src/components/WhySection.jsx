  ...
  const items = [
    {
      ...
      description:
        "Produk kami dibuat dengan menggunakan bahan baku yang berkualitas.",
    },
    {
      icon: tentangKamiIcon2,
      title: "Professional Team",
      description:
        "Kami mempunyai team yang profesional, berpengalaman, dan tersetifikasi.",
    },
    {
      icon: tentangKamiIcon3,
      title: "Prestigious Projects",
      description:
        "Produk kami sudah terpasang di berbagai proyek-proyek ternama.",
    },
    {
      icon: tentangKamiIcon4,
      title: "Industry Production Experience",
      description:
        "Kami sudah berpengalaman dalam memproduksi atap untuk beragam proyek dan aplikasi.",
    },
    {
      icon: tentangKamiIcon5,
      title: "Quality Service & Standarization",
      description:
        "Setiap produk atap kami sudah memenuhi standar dengan quality service yang terjaga.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 gap-8 mt-0 md:-mt-32 md:grid-cols-3 lg:grid-cols-5 md:gap-12">
          {items.map((item, index) => (
            <div
              key={index}
              className="flex flex-col items-center tracking-normal text-center font-helvetica"
            >
              <div className="flex items-center justify-center w-24 h-24 mb-4 bg-white border-none rounded-full md:border md:w-32 md:h-32">
                <img
                  src={item.icon}
                  alt={item.title}
                  className="w-16 md:w-20 filter-red"
                />
              </div>
