  ...
  return (
    <div className="tracking-widest font-bebasneue">
      <div className="flex justify-center overflow-hidden h-[600px]">
        <div className="relative w-full">
          ...
          <div className="absolute flex flex-col items-center transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
            <h1 className="h-auto mb-8 w-96" style={{ display: "none" }}>
              Evertop - Solusi Ide Atap Minimalis dan terbaik
            </h1>
            <img
              src={HeroLogo}
              alt="Evertop - Solusi Ide Atap Minimalis dan terbaik"
      ...
      <div className="flex flex-col items-center justify-center px-1 my-8 font-bold">
        <h2 className="mb-4 text-2xl lg:text-5xl">
          Persebaran Produk <span className="text-[#0d923a]">Evertop</span>
        </h2>
        ...
        <div className="flex flex-wrap justify-center w-2/3 my-10">
          {cities.map((city, index) => (
            <span
              key={index}
              className={`m-2 text-2xl lg:text-4xl ${
                index % 2 === 0 ? "text-black" : "text-[#0d923a]"
              }`}
            >
              {city}
            </span>
      ...
      <div id="lokasi" className="flex flex-col items-center pt-6 pb-10 ">
        <div className="m-4 space-y-2 font-bold text-center w-auto lg:w-[1200px]">
          <h2 className="text-2xl tracking-widest md:text-4xl">
            TEMUKAN <span className="text-[#0d923a]">LOKASI KAMI</span>
          </h2>
          <h2 className="tracking-wider text-2xl sm:text-3xl md:text-5xl lg:text-7xl xl:text-[80px] leading-none">
            PUSAT REVOLUSI MATERIAL KONSTRUKSI TERDEKAT ANDA
          </h2>
        </div>
      </div>
